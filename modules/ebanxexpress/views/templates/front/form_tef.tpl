{capture name=path}{l s='Pagar com transferência eletrônica' mod='ebanxexpress'}{/capture}

<div class="box">
  <h1 class="page-heading">{l s='Pagar com transferência eletrônica' mod='ebanxexpress'}</h1>
